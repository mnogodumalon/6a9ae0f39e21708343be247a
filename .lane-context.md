...
- `anmerkungen` · textarea · Anmerkungen

### `zimmer` — Zimmer (type `Zimmer`, one record: `ZimmerEntry`)
Display fields: `bezeichnung`
- `bezeichnung` · text · Bezeichnung · required! · maxLength 4000
- `kategorie` · lookup · Kategorie · required! · options: einzelzimmer | doppelzimmer | suite
- `preis_pro_nacht` · number · Preis pro Nacht (€) · currency
- `etage` · number · Etage
- `balkon` · bool · Balkon
- `foto` · file · Foto · read-only
Input shapes: choice `kategorie` (ChoiceGroup)

### `zusatzleistungen` — Zusatzleistungen (type `Zusatzleistungen`, one record: `ZusatzleistungenEntry`)
Display fields: `name`
- `name` · text · Name · required! · maxLength 4000
- `preis` · number · Preis (€) · currency
- `aktiv` · bool · Aktiv

### `buchungen` — Buchungen (type `Buchungen`, one record: `BuchungenEntry`)
Display fields: `bemerkung`
- `gast` · record · Gast · required! · → `gaeste`
- `zimmer` · record · Zimmer · required! · → `zimmer`
- `anreise` · date · Anreise · required!
- `abreise` · date · Abreise · required!
- `status` · lookup · Status · required! · options: storniert | bestaetigt | angefragt | eingecheckt | ausgecheckt
- `personen` · number · Personen
- `begleitperson` · record · Begleitperson · → `gaeste`
- `zusatzleistungen_buchung` · multirecord · Zusatzleistungen · → `zusatzleistungen`
- `bemerkung` · textarea · Bemerkung
- `beleg` · file · Beleg · read-only
...
Display fields: `buchung`
- `buchung` · record · Buchung · required! · → `buchungen`
- `betrag` · number · Betrag (€) · required! · currency
- `rechnungsdatum` · date · Rechnungsdatum
- `faellig_am` · date · Fällig am
- `zahlungsstatus` · lookup · Zahlungsstatus · options: offen | teilweise_bezahlt | bezahlt
- `zahlungseingang` · datetime · Zahlungseingang
Input shapes: choice `zahlungsstatus` (ChoiceGroup)
