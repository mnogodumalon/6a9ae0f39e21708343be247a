...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  zimmer: { bezeichnung: "Bitte eine Zimmerbezeichnung eingeben.", kategorie: "Bitte die Zimmerkategorie wählen." },
  zusatzleistungen: { name: "Bitte den Namen der Zusatzleistung eingeben." },
  buchungen: { gast: "Bitte einen Gast auswählen oder neu anlegen.", zimmer: "Bitte ein verfügbares Zimmer wählen.", anreise: "Bitte das Anreisedatum wählen.", abreise: "Bitte das Abreisedatum wählen.", status: "Bitte einen Buchungsstatus wählen." },
