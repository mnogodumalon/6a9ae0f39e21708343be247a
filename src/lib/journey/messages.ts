...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  buchungen: { gast: "Bitte einen Gast auswählen.", zimmer: "Bitte ein Zimmer für den gewünschten Zeitraum wählen.", anreise: "Bitte das Anreisedatum wählen.", abreise: "Bitte das Abreisedatum wählen.", status: "Bitte einen Status wählen." },
  rechnungen: { buchung: "Bitte eine Buchung auswählen.", betrag: "Bitte den Rechnungsbetrag eingeben." },
  // </custom:messages>
};
