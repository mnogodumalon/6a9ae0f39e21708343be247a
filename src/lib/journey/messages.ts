...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  zimmer: { bezeichnung: "Bitte die Zimmerbezeichnung eingeben.", kategorie: "Bitte eine Zimmerkategorie wählen." },
  zusatzleistungen: { name: "Bitte den Namen der Zusatzleistung eingeben." },
  buchungen: { gast: "Bitte einen Gast auswählen oder neu anlegen.", zimmer: "Bitte ein freies Zimmer wählen.", anreise: "Bitte das Anreisedatum wählen.", abreise: "Bitte das Abreisedatum wählen.", status: "Bitte einen Status wählen." },
  rechnungen: { buchung: "Bitte die zugehörige Buchung wählen.", betrag: "Bitte den Rechnungsbetrag eingeben." },
  // </custom:messages>
};
