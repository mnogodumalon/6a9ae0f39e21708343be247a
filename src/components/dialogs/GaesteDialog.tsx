...
export function GaesteDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: GaesteDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'website': (
      <div key="website" className="space-y-1.5">
        <Label htmlFor="website">{fieldLabel('gaeste', 'website')}</Label>
        <Input
          id="website"
          type="url"
          inputMode="url"
    ...
    'newsletter': (
      <div key="newsletter" className="space-y-1.5">
        <Label htmlFor="newsletter">{fieldLabel('gaeste', 'newsletter')}</Label>
        <div className="flex items-center gap-2 pt-1">
          <Checkbox
            id="newsletter"
            checked={!!fields.newsletter}
            onCheckedChange={(v) => setFields(f => ({ ...f, newsletter: !!v }))}
          />
          <Label htmlFor="newsletter" className="font-normal">{fieldLabel('gaeste', 'newsletter')}</Label>
        </div>
      </div>
    ),
    'anmerkungen': (
      <div key="anmerkungen" className="space-y-1.5">
        <Label htmlFor="anmerkungen">{fieldLabel('gaeste', 'anmerkungen')}</Label>
        <Textarea
          id="anmerkungen"
          placeholder="Besondere Wünsche, Diäteinschränkungen, Haustiere..."
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "email": "E-Mail", "telefon": "Telefon", "website": "Website", "plz": "PLZ", "ort": "Ort", "newsletter": "Newsletter", "anmerkungen": "Anmerkungen"};
