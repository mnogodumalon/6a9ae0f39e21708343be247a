...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in 4 Schritten anlegen — Gast, Zimmer, Zeitraum, Zusatzleistungen' },
  { path: '/intents/gast-einchecken', label: { de: 'Gast einchecken', en: 'Check in guest' }, icon: IconLogin, description: 'Gast zu einer bestätigten Buchung einchecken' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung stellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Rechnung zu einer ausgecheckten Buchung erstellen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T08:40:13+00:00';
