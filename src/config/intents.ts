...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in 3 Schritten anlegen – Gast, Zimmer, Zeitraum und Extras' },
  { path: '/intents/gast-einchecken', label: { de: 'Einchecken', en: 'Check in' }, icon: IconDoorEnter, description: 'Gast einchecken und Buchung auf \'Eingecheckt\' setzen' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung stellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Rechnung zu einer Buchung erstellen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T12:05:09+00:00';
