...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/gast-einchecken', label: { de: 'Gast einchecken', en: 'Check in guest' }, icon: IconLogin, description: 'Gast für eine bestätigte Buchung einchecken' },
  { path: '/intents/rechnung-stellen', label: { de: 'Rechnung stellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Rechnung zu einer ausgecheckten Buchung anlegen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T12:55:13+00:00';
