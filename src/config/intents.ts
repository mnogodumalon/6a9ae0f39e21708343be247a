...
// <custom:intent-imports>
import { IconCalendarPlus, IconDoorEnter, IconReceipt } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung anlegen: Gast finden oder neu anlegen, freies Zimmer wählen, Zusatzleistungen hinzufügen' },
  { path: '/intents/gast-einchecken', label: { de: 'Einchecken', en: 'Check in' }, icon: IconDoorEnter, description: 'Gast einchecken: Buchung auswaehlen und Status auf eingecheckt setzen' },
  { path: '/intents/rechnung-stellen', label: { de: 'Rechnung stellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Rechnung zu einer Buchung erstellen und Betrag sowie Faelligkeitsdatum festlegen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T15:36:16+00:00';
