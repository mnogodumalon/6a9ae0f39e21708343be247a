...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in 3 Schritten anlegen — Gast, Zimmer, Details' },
  { path: '/intents/gast-einchecken', label: { de: 'Einchecken', en: 'Check in' }, icon: IconDoorEnter, description: 'Gast einchecken — bestätigte Buchung für heute auswählen und Status auf eingecheckt setzen' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung stellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Rechnung zu einer abgeschlossenen Buchung erstellen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T09:53:42+00:00';
