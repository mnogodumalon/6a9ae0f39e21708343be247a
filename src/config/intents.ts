...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in 3 Schritten anlegen — Gast, Zimmer und Zeitraum' },
  { path: '/intents/gast-einchecken', label: { de: 'Einchecken', en: 'Check in' }, icon: IconDoorEnter, description: 'Gast einchecken — Buchung suchen und Status auf eingecheckt setzen' },
  { path: '/intents/rechnung-stellen', label: { de: 'Rechnung stellen', en: 'Create invoice' }, icon: IconFileInvoice, description: 'Rechnung zu einer Buchung erstellen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T10:57:22+00:00';
